...
<template>
  <div class="app-container">
    <nav class="app-bar">
      ...
      <a v-if="githubUrl" class="app-bar__link" :href="githubUrl" target="_blank" rel="noopener" aria-label="GitHub">
      ...
      <a v-if="feedbackUrl" class="app-bar__link" :href="feedbackUrl" target="_blank" rel="noopener" :aria-label="t('app.feedback')">
